...
public final class MemberServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.hatokuse.grpc.CountRequest,
      com.hatokuse.grpc.CountResponse> getGetLocalCountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLocalCount",
      requestType = com.hatokuse.grpc.CountRequest.class,
      responseType = com.hatokuse.grpc.CountResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hatokuse.grpc.CountRequest,
      com.hatokuse.grpc.CountResponse> getGetLocalCountMethod() {
    io.grpc.MethodDescriptor<com.hatokuse.grpc.CountRequest, com.hatokuse.grpc.CountResponse> getGetLocalCountMethod;
    if ((getGetLocalCountMethod = MemberServiceGrpc.getGetLocalCountMethod) == null) {
      synchronized (MemberServiceGrpc.class) {
        if ((getGetLocalCountMethod = MemberServiceGrpc.getGetLocalCountMethod) == null) {
          MemberServiceGrpc.getGetLocalCountMethod = getGetLocalCountMethod =
              io.grpc.MethodDescriptor.<com.hatokuse.grpc.CountRequest, com.hatokuse.grpc.CountResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetLocalCount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hatokuse.grpc.CountRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hatokuse.grpc.CountResponse.getDefaultInstance()))
              .setSchemaDescriptor(new MemberServiceMethodDescriptorSupplier("GetLocalCount"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getLocalCount(com.hatokuse.grpc.CountRequest request,
  ...
  public static final class MemberServiceStub
    ...
    /**
     */
    public void getLocalCount(com.hatokuse.grpc.CountRequest request,
        io.grpc.stub.StreamObserver<com.hatokuse.grpc.CountResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MemberServiceBlockingStub
    ...
    /**
     */
    public com.hatokuse.grpc.CountResponse getLocalCount(com.hatokuse.grpc.CountRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MemberServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hatokuse.grpc.CountResponse> getLocalCount(
        com.hatokuse.grpc.CountRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
